...
export function StatsWidget() {
  ...
  const limitBytes = 100 * 1024 * 1024; // 100 MB mock limit
  ...
  return (
    <div className="stats-widget">
      <div className="stats-widget-header">
        ...
        <button className="stats-refresh-btn" onClick={loadStats} disabled={loading} title="Làm mới thống kê">
      ...
      <div className="stats-widget-body">
        <div className="stats-total">
          ...
          <span className="stats-total-limit"> / 100 MB</span>
        </div>

        <div className="stats-progress-container">
          <div className="stats-progress-bar">
            <div className="progress-segment images" style={{ width: `${imagesPct}%` }} title={`Images: ${formatBytes(imagesSize)}`} />
            <div className="progress-segment videos" style={{ width: `${videosPct}%` }} title={`Videos: ${formatBytes(videosSize)}`} />
            <div className="progress-segment files" style={{ width: `${filesPct}%` }} title={`Files: ${formatBytes(filesSize)}`} />
          </div>
        </div>
        ...
        <div className="stats-breakdown">
          ...
          <div className="stats-breakdown-item">
            ...
            <span className="label">Tập tin ({breakdown['Files']?.count || 0})</span>
